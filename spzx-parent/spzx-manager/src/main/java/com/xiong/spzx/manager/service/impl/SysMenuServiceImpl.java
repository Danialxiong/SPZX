...
import com.xiong.spzx.manager.mapper.SysMenuMapper;
import com.xiong.spzx.manager.mapper.SysRoleMenuMapper;
import com.xiong.spzx.manager.service.SysMenuService;
import com.xiong.spzx.manager.utils.MenuHelper;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public void removeById(Long id) {
        ...
        if (count > 0) {
            throw new CommonException(ResultCodeEnum.NODE_ERROR);
        }
